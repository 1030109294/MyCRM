...
<script type="text/javascript">
	...
	function unbund(id) {
		if (window.confirm("你确定要取消关联吗？")){
			$.ajax({
				url : "clue/dismissRelated.do",
				data : {
					"id" : id,
				},
				type : "get",
...
<body>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="relatedBtn" data-toggle="modal" data-target="#bundModal" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
