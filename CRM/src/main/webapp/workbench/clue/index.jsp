		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data.totalList,function (i,n) {
					...
					html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href= \'clue/clueDetail.do?id=' + n.id + '\';">'+ n.fullname + '</a></td>';
